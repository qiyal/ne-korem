...
export class Movies {
  ...
  constructor() {
    ...
    this.arrMovies1 = [
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie1.webp', 'Movies - 1', 9.3, new Date(1990, 1, 1), 900, 100),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie2.webp', 'Movies - 2', 5.1, new Date(1990, 1, 1), 699, 100),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie3.webp', 'Movies - 3', 3.5, new Date(1990, 1, 1), 799, 100),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie4.webp', 'Movies - 4', 2.2, new Date(1990, 1, 1), 699, 100),
    ];

    this.arrMovies2 = [
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie1.webp', 'Movies - 1', 9.3, new Date(1990, 1, 1), 900, 90),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie2.webp', 'Movies - 2', 5.1, new Date(1990, 1, 1), 699, 90),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie3.webp', 'Movies - 3', 3.5, new Date(1990, 1, 1), 799, 90),
      new Movie(3000, 6170, '1 h 42 min', '../../assets/images/movies/movie4.webp', 'Movies - 4', 2.2, new Date(1990, 1, 1), 699, 90),
    ];
